...
(function($) {
    ...
    function RecordsCount(obj, settings) {
        ...
        this.create = function() {
            ...
            if (recordsShown < recordsQueryCount && settings.features.paginate) {
                ...
                text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " atÈ " + bounds[1] + "</span> de ";
            } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
                text += recordsShown + " de ";
            }
            text += recordsQueryCount + " registros";
            if (recordsQueryCount < recordsTotal) {
                text += " (filtered from " + recordsTotal + " total records)";
            }
            if(recordsQueryCount == null)
                text = 'carregando'
    ...
    function ProcessingIndicator(obj, settings) {
        ...
        this.create = function() {
            var $processing = $('<div></div>', {
                html: '<div class="loading-icon" style="display: block" style="width:100px;height:120px"> <i class="fa fa-spinner fa-spin fa-3x "></i></div>',
    ...
    function PaginationLinks(obj, settings) {
        ...
        this.create = function() {
            ...
            if(pages > 0){
                pageLinks += '<li><span>P·ginas: </span></li>';
    ...
    utility = dt.utility = {
        ...
        textTransform: {
            ...
            remove_accent: function(str) {
                var accents = '¿¡¬√ƒ≈‡·‚„‰Â“”‘’’÷ÿÚÛÙıˆ¯»… ÀËÈÍÎ«Á–ÃÕŒœÏÌÓÔŸ⁄€‹˘˙˚¸—Ò???ˇ˝??';
            ...
            custom: function(text) {
                text = this.trimDash(text);
                text = this.remove_accent(text);
                text = this.lowercase(text.replace(/(-)/g, '_'));
                return text;
            }
        },
