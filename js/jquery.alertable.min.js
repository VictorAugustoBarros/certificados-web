function hideOverlay() {
    $('.alertable-overlay').css('display', 'none');
    $('.alertable').css('display', 'none');
    $('.alertable').html('');
}
jQuery && function(e) {
    "use strict";
    ...
    e.alertable = {
        ...
        defaults: {
            container: "body",
            html: !1,
            cancelButton: '<button class="alertable-cancel" type="button">Não</button>',
            okButton: '<button class="alertable-ok" type="submit">Sim</button>',
            overlay: '<div class="alertable-overlay" onclick="hideOverlay()"></div>',
